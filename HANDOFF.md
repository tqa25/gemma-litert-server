...
- Latest successful APK build:
  - Run: `https://github.com/tqa25/gemma-litert-server/actions/runs/27095410617`
  - Commit: `4b6a258`
  - Artifact: `gemma-android-backend-debug-apk`
  - APK verified locally at download time: `/tmp/apk-artifact-27095410617/gemma-android-backend-debug-apk/android-backend-debug.apk`, `26106554 bytes`
...
GitHub Actions verification for compact crosshair overlay passed:

```text
Workflow: Android Backend APK
Run: https://github.com/tqa25/gemma-litert-server/actions/runs/27082044857
Commit: d82e1f7
Conclusion: success
Artifact: gemma-android-backend-debug-apk
Downloaded APK: /tmp/apk-artifact-27082044857/gemma-android-backend-debug-apk/android-backend-debug.apk
APK size: 26097990 bytes
```

GitHub Actions verification for automation log terminal passed:
...
GitHub Actions verification for non-touchable tap indicator passed:
...
GitHub Actions verification for JSON workflow runner passed:
...
Conclusion: success
Artifact: gemma-android-backend-debug-apk
Downloaded APK: /tmp/apk-artifact-27095410617/gemma-android-backend-debug-apk/android-backend-debug.apk
APK size: 26106554 bytes
```
